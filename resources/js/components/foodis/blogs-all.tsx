                    ...
                    <section key={post.id} >
                        ...
                        >
                            <img
                                ...
                                alt={post.title}
                            />
                            <div className=" py-4 max-md:px-2 px-8 tracking-tight justify-between overflow-hidden  leading-normal">
                                <h1 className=" text-2xl font-bold ">{post.meta_title}</h1>
                                <div className="overflow-hidden text-sm py-4 max-md:py-2 text-left">
                                    <ReactMarkdown className="" >{post.meta_title}</ReactMarkdown>
